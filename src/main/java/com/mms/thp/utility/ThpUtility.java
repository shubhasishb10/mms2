...
public class ThpUtility {
    ...
    public String shortMedicineNameForBilling(String name) {
        String[] nameParts = name.split(" ");
        String shortName = "";
        if(nameParts.length > 1) {
            //TODO refactor the name for multi name medicine
        } else {
            //TODO refactor medicine name for single medicine name
        }
        return null;
    }
